$(function() {
	...
	function setZIndex(flag){
		return;
		if(flag==0){
		window.top.document.getElementById("indexFrame").style["z-index"]="0";
		}else{
		window.top.document.getElementById("indexFrame").style["z-index"]="100";
		}
	}
	$(".loginmask,.closealert").click(function() {
		...
		$(".loginmask,.closeareg").click(function() {
		k && (k = !1, $("#reg_setp").animate({
			top: -600
		}, 400, "easeOutQuart", function() {
			$("#reg_setp").hide();
			k = !0
